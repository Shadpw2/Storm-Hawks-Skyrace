...
BW_FOUR_CHANNEL_COLOURISE( skinColour, "Skin Colour", "Custom colour for skin",
			   clothesColour01, "Clothes Colour 1", "Custom colour for hair",
			   clothesColour02, "Clothes Colour 2", "Custom colour for eyes",
			   extraColour, "extraColour", "Extra custom colour" )
...
//INK START
OutputDiffuseLighting2 vs_main_ink( VertexXYZNUVIIIWW input )
{
	OutputDiffuseLighting2 o = (OutputDiffuseLighting2)0;
	...
	float4 worldPos = transformPos( tmpPos, weights, indices );	
...
>
{
	...
	pass Pass_ink
	{
		...
		BW_FOG
		CULLMODE = 2;
		VertexShader = compile vs_2_0 vs_main_ink();
