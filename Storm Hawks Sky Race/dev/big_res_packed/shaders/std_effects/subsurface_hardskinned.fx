...
Output vs_main_3_0( VertexXYZNUVITB input )
{
	...
	output.normal = transformNormaliseVector( input.normal, input.index );
	output.tangent = transformNormaliseVector( input.tangent, input.index );
	output.binormal = transformNormaliseVector( input.binormal, input.index );	
...
Output_2_0 vs_main_2_0( VertexXYZNUVITB input,
