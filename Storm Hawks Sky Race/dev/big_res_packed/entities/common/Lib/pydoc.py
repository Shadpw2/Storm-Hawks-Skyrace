...
# Embedded file name: /entities/common/Lib/pydoc.py
...
def visiblename(name, all=None):
    ...
    if name in ('__builtins__', '__doc__', '__file__', '__path__', '__module__', '__name__',
                '__slots__'):
        return 0
...
class Doc():
    ...
    def getdocloc(self, object):
        ...
        if isinstance(object, type(os)) and (object.__name__ in ('errno', 'exceptions',
                                                                 ...
                                                                 'posix', 'signal',
                                                                 'sys', 'thread',
                                                                 'zipimport') or file.startswith(basedir) and not file.startswith(os.path.join(basedir, 'site-packages'))):
