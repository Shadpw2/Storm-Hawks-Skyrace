...
# Embedded file name: /entities/common/Lib/decimal.py
...
__all__ = [
 ...
 'DecimalException', 
 'Clamped', 'InvalidOperation', 'DivisionByZero', 
 'Inexact', 'Rounded', 
 'Subnormal', 'Overflow', 'Underflow', 
 'ROUND_DOWN', 'ROUND_HALF_UP', 'ROUND_HALF_EVEN', 
 'ROUND_CEILING', 
...
class Decimal(object):
    ...
    def as_tuple(self):
        ...
        """
        return (
         self._sign, tuple(map(int, self._int)), self._exp)
