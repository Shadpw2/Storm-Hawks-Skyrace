...
# Embedded file name: /entities/common/Lib/sre_parse.py
        ...
        if this and this[0] == '\\':
            ...
            if c == 'g':
                ...
                if s.next in DIGITS:
                    this = this + sget()
                    if c in OCTDIGITS:
                        if this[2] in OCTDIGITS and s.next in OCTDIGITS:
                            this = this + sget()
                            isoctal = True
                            literal(makechar(int(this[1:], 8) & 255))
                    isoctal or a((MARK, int(this[1:])))
            else:
                try:
