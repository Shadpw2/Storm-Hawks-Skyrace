...
# Embedded file name: /entities/common/Lib/distutils/bcppcompiler.py
...
__revision__ = '$Id$'
import sys, os
from distutils.errors import DistutilsExecError, DistutilsPlatformError, CompileError, LibError, LinkError, UnknownFileError
