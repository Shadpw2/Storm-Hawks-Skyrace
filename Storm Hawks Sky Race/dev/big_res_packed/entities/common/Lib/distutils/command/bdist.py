...
# Embedded file name: /entities/common/Lib/distutils/command/bdist.py
# Compiled at: 2008-12-16 09:38:05
...
class bdist(Command):
    ...
    format_commands = [
     ...
     'wininst', 
     'zip']
    format_command = {'rpm': ('bdist_rpm', 'RPM distribution'), 'zip': ('bdist_dumb', 'ZIP file'), 
