...
# Embedded file name: /entities/common/Lib/xmlrpclib.py
...
def dumps(params, methodname=None, methodresponse=None, encoding=None, allow_none=0):
    ...
    if isinstance(params, Fault):
        ...
        if isinstance(params, TupleType):
            pass
        else:
            raise len(params) == 1 or AssertionError, 'response tuple must be a singleton'
    if not encoding:
        encoding = 'utf-8'
    if FastMarshaller:
