...
# Embedded file name: /entities/common/Lib/bsddb/test/test_compare.py
...
class ComparatorTests(unittest.TestCase):
    ...
    def comparator_test_helper(self, comparator, expected_data):
        ...
        self.failUnless(data == expected_data, "comparator `%s' is not right: %s vs. %s" % (
...
class AbstractBtreeKeyCompareTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        env = db.DBEnv()
        env.open(homeDir, db.DB_CREATE | db.DB_INIT_MPOOL | db.DB_INIT_LOCK | db.DB_THREAD)
        self.env = env
    ...
    def check_results(self, expected):
        ...
        try:
            ...
            while rec:
                ...
                self.failUnless(expected[index] == key, "expected value `%s' at %d but got `%s'" % (
