...
# Embedded file name: /entities/common/Lib/bsddb/test/test_associate.py
# Compiled at: 2008-12-16 09:37:56
"""
TestCases for DB.associate.
"""
import sys, os, string, tempfile, time
...
class AssociateTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.env = db.DBEnv()
        self.env.open(homeDir, db.DB_CREATE | db.DB_INIT_MPOOL | db.DB_INIT_LOCK | db.DB_THREAD | self.envFlags)
