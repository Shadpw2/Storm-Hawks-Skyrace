...
# Embedded file name: /entities/common/Lib/profile.py
        ...
        if self.cur:
            if frame.f_back is not self.cur[-2]:
                ...
                if not isinstance(rframe, Profile.fake_frame):
                    ...
                    raise rframe.f_back is frame.f_back or AssertionError, ('Bad call', rfn,
                     rframe, rframe.f_back,
                     frame, frame.f_back)
                self.trace_dispatch_return(rframe, 0)
                assert self.cur is None or frame.f_back is self.cur[-2], ('Bad call',
                 self.cur[-3])
        fcode = frame.f_code
