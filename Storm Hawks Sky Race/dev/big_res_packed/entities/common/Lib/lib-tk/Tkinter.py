...
# Embedded file name: /entities/common/Lib/lib-tk/Tkinter.py
...
class Text(Widget):
    ...
    def search(self, pattern, index, stopindex=None, forwards=None, backwards=None, exact=None, regexp=None, nocase=None, count=None):
