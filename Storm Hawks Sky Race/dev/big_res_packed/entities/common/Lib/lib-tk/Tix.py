...
# Embedded file name: /entities/common/Lib/lib-tk/Tix.py
...
class DisplayStyle:
    ...
    def __init__(self, itemtype, cnf={}, **kw):
        ...
        if not master and cnf.has_key('refwindow'):
            master = cnf['refwindow']
        elif not master and kw.has_key('refwindow'):
            master = kw['refwindow']
        elif not master:
...
class Balloon(TixWidget):
    ...
    def __init__(self, master=None, cnf={}, **kw):
        static = [
         'options', 'installcolormap', 'initwait', 'statusbar', 
         'cursor']
...
class HList(TixWidget):
    ...
    def header_configure(self, col, cnf={}, **kw):
        if cnf is None:
            return _lst2dict(self.tk.split(self.tk.call(self._w, 'header', 'configure', col)))
    ...
    def indicator_configure(self, entry, cnf={}, **kw):
        if cnf is None:
            return _lst2dict(self.tk.split(self.tk.call(self._w, 'indicator', 'configure', entry)))
    ...
    def item_configure(self, entry, col, cnf={}, **kw):
        if cnf is None:
            return _lst2dict(self.tk.split(self.tk.call(self._w, 'item', 'configure', entry, col)))
    ...
    def entryconfigure(self, entry, cnf={}, **kw):
        if cnf is None:
            return _lst2dict(self.tk.split(self.tk.call(self._w, 'entryconfigure', entry)))
...
class PanedWindow(TixWidget):
    ...
    def paneconfigure(self, entry, cnf={}, **kw):
        if cnf is None:
            return _lst2dict(self.tk.split(self.tk.call(self._w, 'paneconfigure', entry)))
...
class ResizeHandle(TixWidget):
    ...
    def __init__(self, master, cnf={}, **kw):
        flags = [
         'options', 'command', 'cursorfg', 'cursorbg', 
         'handlesize', 
         'hintcolor', 'hintwidth', 
         'x', 'y']
...
class DialogShell(TixWidget):
    ...
    def __init__(self, master=None, cnf={}, **kw):
        TixWidget.__init__(self, master, 'tixDialogShell', [
