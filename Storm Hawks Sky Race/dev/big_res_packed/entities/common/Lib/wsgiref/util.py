...
# Embedded file name: /entities/common/Lib/wsgiref/util.py
...
def shift_path_info(environ):
    ...
    path_parts[1:(-1)] = [ p for p in path_parts[1:-1] if p if p != '.' ]
    name = path_parts[1]
    del path_parts[1]
...
_hoppish = {'connection': 1, 
   ...
   'te': 1, 'trailers': 1, 'transfer-encoding': 1, 'upgrade': 1}.has_key
