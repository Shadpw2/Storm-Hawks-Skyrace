...
# Embedded file name: /entities/common/Lib/mailbox.py
# Compiled at: 2008-12-16 09:37:45
"""Read/write support for Maildir, mbox, MH, Babyl, and MMDF mailboxes."""
import sys, os, time, calendar, socket, errno, copy, email, email.Message, email.Generator, rfc822, StringIO
try:
...
__all__ = ['Mailbox', 'Maildir', 'mbox', 'MH', 'Babyl', 'MMDF', 
 ...
 'mboxMessage', 'MHMessage', 
 'BabylMessage', 'MMDFMessage', 'UnixMailbox', 
 'PortableUnixMailbox', 
 'MmdfMailbox', 'MHMailbox', 'BabylMailbox']
...
class Babyl(_singlefileMailbox):
    ...
    _special_labels = frozenset(('unseen', 'deleted', 'filed', 'answered', 'forwarded',
                                 'edited', 'resent'))
    ...
    def _pre_mailbox_hook(self, f):
        """Called before writing the mailbox to file f."""
        f.write('BABYL OPTIONS:%sVersion: 5%sLabels:%s%s\x1f' % (
...
class Message(email.Message.Message):
    ...
    def _become_message(self, message):
        ...
        for name in ('_headers', '_unixfrom', '_payload', '_charset', 'preamble', 'epilogue',
                     'defects', '_default_type'):
