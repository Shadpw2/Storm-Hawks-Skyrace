...
# Embedded file name: /entities/common/Lib/DocXMLRPCServer.py
...
class DocXMLRPCServer(SimpleXMLRPCServer, XMLRPCDocGenerator):
    ...
    def __init__(self, addr, requestHandler=DocXMLRPCRequestHandler, logRequests=1):
