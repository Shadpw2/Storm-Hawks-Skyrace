...
# Embedded file name: /entities/common/Lib/SimpleXMLRPCServer.py
...
import SocketServer, BaseHTTPServer, sys, os
try:
    import fcntl
except ImportError:
    fcntl = None
    ...
    def system_multicall(self, call_list):
        ...
        for call in call_list:
            ...
            try:
                ...
                results.append({'faultCode': 1, 'faultString': '%s:%s' % (sys.exc_type, sys.exc_value)})
...
class SimpleXMLRPCServer(SocketServer.TCPServer, SimpleXMLRPCDispatcher):
    ...
    def __init__(self, addr, requestHandler=SimpleXMLRPCRequestHandler, logRequests=True, allow_none=False, encoding=None):
