...
# Embedded file name: /entities/common/Lib/ctypes/test/test_byteswap.py
...
class Test(unittest.TestCase):
    ...
    def test_endian_short(self):
        ...
        self.failUnlessEqual(bin(struct.pack('>h', 4660)), '1234')
        self.failUnlessEqual(bin(s), '1234')
        self.failUnlessEqual(s.value, 4660)
        s = c_short.__ctype_le__(4660)
        self.failUnlessEqual(bin(struct.pack('<h', 4660)), '3412')
    ...
    def test_endian_int(self):
        ...
        self.failUnlessEqual(bin(struct.pack('>i', 305419896)), '12345678')
        self.failUnlessEqual(bin(s), '12345678')
        self.failUnlessEqual(s.value, 305419896)
        s = c_int.__ctype_le__(305419896)
        self.failUnlessEqual(bin(struct.pack('<i', 305419896)), '78563412')
    ...
    def test_endian_longlong(self):
        ...
        self.failUnlessEqual(bin(struct.pack('>q', 1311768467294899695L)), '1234567890ABCDEF')
        self.failUnlessEqual(bin(s), '1234567890ABCDEF')
        self.failUnlessEqual(s.value, 1311768467294899695L)
        s = c_longlong.__ctype_le__(1311768467294899695L)
        self.failUnlessEqual(bin(struct.pack('<q', 1311768467294899695L)), 'EFCDAB9078563412')
