...
# Embedded file name: /entities/common/Lib/ctypes/test/test_structures.py
...
class StructureTestCase(unittest.TestCase):
    ...
    def test_init_errors(self):
        ...
        if issubclass(Exception, object):
            self.failUnlessEqual(msg, "(Phone) <type 'exceptions.TypeError'>: expected string or Unicode object, int found")
        else:
            self.failUnlessEqual(msg, '(Phone) exceptions.TypeError: expected string or Unicode object, int found')
        (cls, msg) = self.get_except(Person, 'Someone', ('a', 'b', 'c'))
        self.failUnlessEqual(cls, RuntimeError)
        if issubclass(Exception, object):
            self.failUnlessEqual(msg, "(Phone) <type 'exceptions.ValueError'>: too many initializers")
        else:
...
class TestRecursiveStructure(unittest.TestCase):
    ...
    def test_contains_itself(self):
        ...
        try:
            ...
            self.failUnless('Structure or union cannot contain itself' in str(details))
        else:
    ...
    def test_vice_versa(self):
        ...
        try:
            ...
            self.failUnless('_fields_ is final' in str(details))
        else:
