...
# Embedded file name: /entities/common/Lib/ctypes/test/test_cfuncs.py
...
class CFunctions(unittest.TestCase):
    ...
    def test_uint(self):
        ...
        self.failUnlessEqual(self._dll.tf_I(4294967295L), 1431655765)
        self.failUnlessEqual(self.U(), 4294967295L)

    def test_uint_plus(self):
        self._dll.tf_bI.restype = c_uint
        self._dll.tf_bI.argtypes = (c_byte, c_uint)
        self.failUnlessEqual(self._dll.tf_bI(0, 4294967295L), 1431655765)
        self.failUnlessEqual(self.U(), 4294967295L)
    ...
    def test_ulong(self):
        ...
        self.failUnlessEqual(self._dll.tf_L(4294967295L), 1431655765)
        self.failUnlessEqual(self.U(), 4294967295L)

    def test_ulong_plus(self):
        self._dll.tf_bL.restype = c_ulong
        self._dll.tf_bL.argtypes = (c_char, c_ulong)
        self.failUnlessEqual(self._dll.tf_bL(' ', 4294967295L), 1431655765)
        self.failUnlessEqual(self.U(), 4294967295L)

    def test_longlong(self):
        self._dll.tf_q.restype = c_longlong
        self._dll.tf_q.argtypes = (c_longlong,)
        self.failUnlessEqual(self._dll.tf_q(-9223372036854775806L), -3074457345618258602L)
        self.failUnlessEqual(self.S(), -9223372036854775806L)

    def test_longlong_plus(self):
        self._dll.tf_bq.restype = c_longlong
        self._dll.tf_bq.argtypes = (c_byte, c_longlong)
        self.failUnlessEqual(self._dll.tf_bq(0, -9223372036854775806L), -3074457345618258602L)
        self.failUnlessEqual(self.S(), -9223372036854775806L)

    def test_ulonglong(self):
        self._dll.tf_Q.restype = c_ulonglong
        self._dll.tf_Q.argtypes = (c_ulonglong,)
        self.failUnlessEqual(self._dll.tf_Q(18446744073709551615L), 6148914691236517205L)
        self.failUnlessEqual(self.U(), 18446744073709551615L)

    def test_ulonglong_plus(self):
        self._dll.tf_bQ.restype = c_ulonglong
        self._dll.tf_bQ.argtypes = (c_byte, c_ulonglong)
        self.failUnlessEqual(self._dll.tf_bQ(0, 18446744073709551615L), 6148914691236517205L)
        self.failUnlessEqual(self.U(), 18446744073709551615L)

    def test_float(self):
        self._dll.tf_f.restype = c_float
        self._dll.tf_f.argtypes = (c_float,)
        self.failUnlessEqual(self._dll.tf_f(-42.0), -14.0)
