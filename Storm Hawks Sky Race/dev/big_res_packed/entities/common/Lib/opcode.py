...
# Embedded file name: /entities/common/Lib/opcode.py
...
def_op('BUILD_MAP', 104)
name_op('LOAD_ATTR', 105)
def_op('COMPARE_OP', 106)
hascompare.append(106)
name_op('IMPORT_NAME', 107)
name_op('IMPORT_FROM', 108)
