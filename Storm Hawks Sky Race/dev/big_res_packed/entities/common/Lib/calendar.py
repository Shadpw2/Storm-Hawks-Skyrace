...
# Embedded file name: /entities/common/Lib/calendar.py
...
__all__ = [
 ...
 'monthcalendar', 'prmonth', 
 'month', 'prcal', 'calendar', 
 'timegm', 'month_name', 'month_abbr', 'day_name', 
 'day_abbr']
error = ValueError
...
class Calendar(object):
    ...
    def yeardatescalendar(self, year, width=3):
        ...
        """
        months = [ self.monthdatescalendar(year, i) for i in xrange(January, January + 12)
                 ]
    ...
    def yeardays2calendar(self, year, width=3):
        ...
        zero.
        """
        months = [ self.monthdays2calendar(year, i) for i in xrange(January, January + 12)
                 ]
        return [ months[i:i + width] for i in xrange(0, len(months), width) ]
    ...
    def yeardayscalendar(self, year, width=3):
        ...
        """
        months = [ self.monthdayscalendar(year, i) for i in xrange(January, January + 12)
                 ]
        return [ months[i:i + width] for i in xrange(0, len(months), width) ]
