...
# Embedded file name: /entities/common/Lib/posixfile.py
# Compiled at: 2008-12-16 09:37:48
...
class _posixfile_:
    ...
    def lock(self, how, *args):
        ...
        if len(args) == 1:
            ...
            raise TypeError, 'too many arguments'
        import sys, os
        if sys.platform in ('netbsd1', 'openbsd2', 'freebsd2', 'freebsd3', 'freebsd4',
                            'freebsd5', 'freebsd6', 'freebsd7', 'bsdos2', 'bsdos3',
                            'bsdos4'):
        ...
        if '?' in how:
            ...
            if l_type != fcntl.F_UNLCK:
                if l_type == fcntl.F_RDLCK:
                    return (
                     'r', l_len, l_start, l_whence, l_pid)
                else:
                    return (
                     'w', l_len, l_start, l_whence, l_pid)
