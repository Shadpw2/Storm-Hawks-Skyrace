...
# Embedded file name: /entities/common/Lib/compiler/pyassem.py
...
class Block():
    ...
    _uncond_transfer = ('RETURN_VALUE', 'RAISE_VARARGS', 'YIELD_VALUE', 'JUMP_ABSOLUTE',
